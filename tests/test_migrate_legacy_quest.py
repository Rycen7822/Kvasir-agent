...
def test_migrate_legacy_quest_creates_manifest_and_report_without_deleting_source(tmp_path: Path):
    ...
    from kvasir_agent.services.migrations import MigrationService
    ...
    report = json.loads((tmp_path / "Kvasir-agent" / "migrations" / "migration_report.json").read_text(encoding="utf-8"))
