...
description: Compact Kvasir-agent router for paper reliability verification; use for bounded reliability checks while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# ka-paper-reliability compact router
