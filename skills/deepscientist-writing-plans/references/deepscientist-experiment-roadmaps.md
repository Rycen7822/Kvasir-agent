# DeepScientist ordered experiment roadmap pattern

Use this reference when a user asks for an experiment execution plan derived from a DeepScientist quest's `idea/` documents.

## Trigger

- User asks for a plan under `DeepScientist/quests/<id>/experiments`.
...
- DeepScientist artifact/memory rules
