...
Use this reference when a Kvasir-agent experiment command document advances from a Phase 2 selector subset template into a per-model retrofit-plan step, but the real selector inputs do not yet exist.
