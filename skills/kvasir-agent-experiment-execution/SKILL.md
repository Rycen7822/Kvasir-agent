...
description: Compact Kvasir-agent router for kvasir-agent-experiment-execution; use for its research stage while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# kvasir-agent-experiment-execution compact router
