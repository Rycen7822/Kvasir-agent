...
description: Compact Codex-Scientist router for deepscientist-paper-reliability-verification; use for its research stage while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# deepscientist-paper-reliability-verification compact router
...
1. Read `DeepScientist/research.yaml` and `DeepScientist/summaries/context_pack.md` when present.
