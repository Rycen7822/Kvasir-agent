...
description: Compact Codex-Scientist router for codexscientist-decision; use for its research stage while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# codexscientist-decision compact router
