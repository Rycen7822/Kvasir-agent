...
description: Compact Kvasir-agent router for kvasir-agent-writing-plans; use for its research stage while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# kvasir-agent-writing-plans compact router
