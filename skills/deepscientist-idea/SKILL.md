...
description: Compact Codex-Scientist router for deepscientist-idea; use for its research stage while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# deepscientist-idea compact router
