...
description: Compact Codex-Scientist router for codexscientist-experiment-execution; use for its research stage while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# codexscientist-experiment-execution compact router
