---
name: codexscientist-figure-polish
...
CodexScientist figures should feel academic, restrained, and clear.
...
- `assets/codexscientist-academic.mplstyle`
...
- `plt.style.use(<path-to-assets/codexscientist-academic.mplstyle>)`
