...
description: Compact Codex-Scientist router for deepscientist-paper-fetch; use for its research stage while keeping Codex-native operations outside the plugin runtime.
version: 2.0.0
---

# deepscientist-paper-fetch compact router
