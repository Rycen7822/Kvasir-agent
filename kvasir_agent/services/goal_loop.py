...
_DEFAULT_ACTIONS: dict[str, dict[str, Any]] = {
    "scout": {
        ...
        "required_tool": "ka_record_user_requirement",
    ...
    "strict-research": {
        ...
        "required_tool": "ka_memory_search",
    ...
    "baseline": {
        ...
        "required_tool": "ka_create_local_baseline",
    ...
    "optimize": {
        ...
        "required_tool": "ka_get_optimization_frontier",
        "required_inputs": [],
        "blocking_reason": None,
    ...
    "experiment": {
        ...
        "required_tool": "ka_record_main_experiment",
    ...
    "analysis-campaign": {
        ...
        "required_tool": "ka_record_analysis_slice",
    ...
    "write": {
        ...
        "required_tool": "ka_submit_paper_bundle",
        "required_inputs": [],
        "blocking_reason": None,
