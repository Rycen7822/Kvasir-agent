...
class MethodImprovementService:
    ...
    def _analysis_slice_statuses(self, quest_id: str) -> dict[str, dict[str, Any]]:
        campaigns_root = self.layout.state_root / ".ka" / "analysis_campaigns"
            ...
            payload.update({
                ...
                "retry_template": {
                    ...
                    "required_before_retry": [
                        ...
                        "completed analysis_slice_ids from ka_record_analysis_slice",
                        "seed_count >= 2",
                    ],
                },
                "suggested_next_action": "Complete and record the referenced analysis slices, verify evidence paths exist, then retry ka_claim_gate.",
            })
        return payload
