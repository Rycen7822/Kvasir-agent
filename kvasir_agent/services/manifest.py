    ...
    def default_manifest(self, *, name: str, goal: str) -> dict[str, Any]:
        ...
        return {
            ...
            "quest": {
                ...
                "root_bound": True,
                "title": goal,
                "created_by": "kvasir-agent-plugin",
                "created_at": created_at,
            },
            ...
            "paths": {
                ...
                "exclude_paths": ["Kvasir-agent/**", ".git/**"],
    ...
    def ensure_initialized(
        ...
        *,
        ...
        if legacy_status.status == "multiple_legacy_quests_blocked":
            return {
                "ok": False,
                "error": "Multiple legacy Kvasir-agent quests require manual migration before writing root-bound state.",
