        ...
        *,
        ...
        return "\n".join(
            [
                ...
                "- surface_rule: Kvasir-agent is running as a Hermes-headless backend; Hermes is the only user-facing surface.",
