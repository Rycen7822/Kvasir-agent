# Kvasir-agent code-only implementation passes

Use this reference when the user asks to implement experiment code from a Kvasir-agent experiment roadmap while explicitly forbidding real experiments.
...
8. Record durable state at the end: project research records for reusable implementation status and a milestone artifact with paths, validation summary, and the no-experiment scope.
