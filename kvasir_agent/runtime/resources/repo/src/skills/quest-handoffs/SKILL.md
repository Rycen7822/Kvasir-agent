...
description: Create durable Kvasir-agent quest handoff documents, AGENTS.md files, researcher packages, and verified sync artifacts.
version: 1.0.1
metadata:
  hermes:
    category: research
...
Use this skill when the user asks for onboarding notes, a guide for another agent, an `AGENTS.md`, a quick-start document, or a synced handoff for a research/Kvasir-agent quest.
...
1. Read quest state with Kvasir-agent tools when available.
