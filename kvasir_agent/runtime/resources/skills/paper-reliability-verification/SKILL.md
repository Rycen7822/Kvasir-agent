...
> Use `ka_paper_reliability_verify` as the primary Kvasir-agent tool wrapper; it stores reliability cards under project-local `reference/reliability_cards/` and keeps `accepted_publication` evidence auditable.
