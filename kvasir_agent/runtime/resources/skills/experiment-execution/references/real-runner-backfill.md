...
4. Run the real bounded formal command with `ka_bash_exec` and validate artifacts from disk, not only stdout.
5. Write run summary JSON/MD, record `ka_record_main_experiment`, then record a milestone and route decision.
