...
- **Use Codex-native execution for routine shell/CLI/Python/node/git/npm/uv/environment checks. Use `ka_bash_exec` for baseline setup, reproduction, monitoring, or verification that must be durable research evidence.**
