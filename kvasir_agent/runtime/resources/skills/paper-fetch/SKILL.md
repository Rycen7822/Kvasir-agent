---
name: paper-fetch
description: Use when a Kvasir-agent project needs project-local paper retrieval, arXiv/OpenReview PDF reading, or official resource verification without clipping into llm-wiki.
skill_role: support
version: 1.0.0
author: Codex Agent
license: MIT
...
- `paper-fetch` gets paper evidence for the current Kvasir-agent project.
