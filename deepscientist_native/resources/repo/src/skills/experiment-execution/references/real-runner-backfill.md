...
4. Run the real bounded formal command with `ds_bash_exec` and validate artifacts from disk, not only stdout.
5. Write run summary JSON/MD, record `ds_record_main_experiment`, then record a milestone and route decision.
