...
def get_channel_factory(name: str):
    raise RuntimeError("DeepScientist connector channels are disabled in Hermes-headless backend.")
        ...
        if completion_request is None:
            return {
                ...
                "message": (
                    ...
                    "Ask the user through Hermes and record the decision with a curated ds_* tool; "
