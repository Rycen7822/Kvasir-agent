    ...
    def record_artifact_interaction(
        ...
        *,
        ...
        runtime_updates: dict[str, Any] = {
            ...
            "last_tool_activity_name": "ds_artifact_record",
            "tool_calls_since_last_artifact_interact": 0,
            "pending_user_message_count": len((self._read_message_queue(quest_root).get("pending") or [])),
        }
        ...
        *,
        ...
        if delivered_messages:
            lines = [
                ...
                self.localized_copy(
                    quest_root=quest_root,
                    zh="- 完成该用户请求后，再立刻通过 Hermes 汇报完整结果，并按需使用 ds_artifact_record 记录进展。",
                    en="- After completing that user request, immediately report the full result through Hermes and use ds_artifact_record when a durable progress artifact is needed.",
                ),
                self.localized_copy(
                    quest_root=quest_root,
