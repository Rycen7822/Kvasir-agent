    ...
    *,
    ...
    return {
        ...
        "native_tool_servers_disabled": [
            {"name": "ds_memory", "call_surface": "dsctl", "scope": "quest-local"},
            {"name": "ds_artifact", "call_surface": "dsctl", "scope": "quest-local"},
            {"name": "ds_bash_exec", "call_surface": "dsctl", "scope": "quest-local"},
        ],
