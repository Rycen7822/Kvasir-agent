...
def build_session_descriptor(
    ...
    *,
    ...
    return {
        "profile": "codexscientist-acp-compat/v1",
        ...
        "native_tool_servers_disabled": [
            {"name": "cs_memory", "call_surface": "csctl", "scope": "quest-local"},
            {"name": "cs_artifact", "call_surface": "csctl", "scope": "quest-local"},
            {"name": "cs_bash_exec", "call_surface": "csctl", "scope": "quest-local"},
        ],
    ...
    *,
    ...
    if event_type == "conversation.message":
        ...
        update_payload["data"] = {
            ...
            "status": event.get("status"),
            "args": event.get("args"),
            "native_tool_server": event.get("native_tool_server"),
            "native_tool_tool": event.get("native_tool_tool"),
