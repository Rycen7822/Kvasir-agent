# Kvasir-agent formal experiment command handoffs
...
2. "执行前必读" section:
   ...
   - If commands are run as Kvasir-agent quest evidence, they must go through public MCP `ka_bash_exec`.
...
7. Kvasir-agent recording instructions:
