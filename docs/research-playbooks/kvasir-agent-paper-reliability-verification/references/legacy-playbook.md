...
---
name: kvasir-agent-paper-reliability-verification
description: Verify paper reliability through the bundled Kvasir-agent verifier workflow before using papers as evidence.
version: 1.1.2
...
> Use `ka_paper_reliability_verify` as the primary Kvasir-agent tool wrapper; it stores reliability cards under quest-local `reference/reliability_cards/` and keeps `accepted_publication` evidence auditable.
...
- evaluating papers found during literature review or Kvasir-agent research;
...
- merely downloading PDFs; use the Kvasir-agent `paper-fetch` workflow for retrieval;
...
```text
resources/skills/paper-reliability-verifier/subskills/openreview-accepted-venue/GUIDE.md
```
...
```text
resources/skills/paper-reliability-verifier/subskills/acl-anthology-accepted-venue/GUIDE.md
```
...
```text
resources/skills/paper-reliability-verifier/subskills/dblp-accepted-venue/GUIDE.md
```
