#!/usr/bin/env python3
"""Kvasir-agent MCP stdio entrypoint and smoke-test helper."""
...
from kvasir_agent.mcp.server import call_tool_payload, initialize_payload, list_tools_payload, run_stdio  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Kvasir-agent MCP server")
